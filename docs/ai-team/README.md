...
4. 用 [evaluation-rubric.md](./evaluation-rubric.md)：验收 AI-MBTI、工程和报告质量；AI-HQ 仅作为 archived 路径检查。
...
- “开一轮 AI-MBTI 报告质量改进。”
- “让 AI 团队检查 archived AI-HQ 是否影响主线。”
- “实现无法回答选项，并检查全链路。”
...
1. 保持 AI-MBTI 主线快速可用，AI-HQ 只保留 archived compatibility。
2. 提升报告具体性、行动价值和证据感。
