...
> = {
  body: {
    ...
    code: "px-1 py-0.5 rounded bg-void text-[13px] font-mono text-raycast-blue border border-[rgba(255,255,255,0.08)]",
    pre: "mb-3 p-3 rounded-[10px] bg-void border border-[rgba(255,255,255,0.08)] overflow-x-auto text-[13px] font-mono text-light-gray",
  },
  summary: {
    ...
    code: "px-1 py-0.5 rounded bg-void text-[18px] font-mono text-raycast-blue border border-[rgba(255,255,255,0.08)]",
    pre: "mb-3 p-3 rounded-[10px] bg-void border border-[rgba(255,255,255,0.08)] overflow-x-auto text-[14px] font-mono text-light-gray",
  },
  compact: {
    ...
    code: "px-1 py-0.5 rounded bg-void text-[12px] font-mono text-raycast-blue border border-[rgba(255,255,255,0.08)]",
    pre: "mb-2 p-3 rounded-[10px] bg-void border border-[rgba(255,255,255,0.08)] overflow-x-auto text-[12px] font-mono text-light-gray",
  },
};
